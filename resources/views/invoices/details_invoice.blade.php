...
@section('content')
                                            ...
                                            <div class="table-responsive mt-15">
                                                <table class="table table-striped" style="text-align:center">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>{{ $invoices->Section?$invoices->Section->section_name:"" }}</td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <table class="table center-aligned-table mb-0 table table-hover"
                                                        ...
                                                        @forelse($attachments  ?? [] as $attachment)
                                                            <tr>
                                                                ...
                                                                @can('owner')
                                                                    <td colspan="2">
                                                                        <button class="btn btn-outline-danger btn-sm" data-toggle="modal" data-target="#deleteAttachment">حذف</button>
                                                                    </td>
                                                                @endcan
    ...
    <div class="modal fade" id="deleteAttachment" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
